...
spm_path = '/home/degutis/repos/spm'
...
def check_spm_path():
    ...
    print("TPM exists:", os.path.exists(os.path.join(spm_path, "tpm", "TPM.nii")))
    print("SPM version:", spm.SPMCommand().version)
...
def mp2rage_recon_all(inv2_file,uni_file,output_fs_dir=None, gdc_coeff_file=None):
    ...
    # brainmask_data = np.array(((wm_data > 0.1) | (gm_data > 0.1)),dtype=int)
