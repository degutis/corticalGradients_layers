...
class cat12_seg(MatlabCommand):
    ...
    def _my_script(self):
        ...
        matlabbatch{1}.spm.tools.cat.estwrite.opts.biasacc = 0.8; 
        ...
        matlabbatch{1}.spm.tools.cat.estwrite.extopts.LASstr = 0.8;
        matlabbatch{1}.spm.tools.cat.estwrite.extopts.LASmyostr = 0;
        matlabbatch{1}.spm.tools.cat.estwrite.extopts.gcutstr = 0.25;
