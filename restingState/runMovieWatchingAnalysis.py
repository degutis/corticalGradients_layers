...
eigvals_between, eigvecs_between = restStateSub.runLaplacianEmbedding(adj_matrix_between, name, full=True)
restStateSub.plotScree(eigvals_between, name)
crossingsWithin = restStateSub.run_plot_zeroCrossings(adj_matrix_between, eigvecs_between, name)
restStateSub.eigvecs_to_nifti(eigvecs_between, name, hcp_atlas=hcplabels)
restStateSub.plotTwoDimEmbedding(eigvecs_between, name)
